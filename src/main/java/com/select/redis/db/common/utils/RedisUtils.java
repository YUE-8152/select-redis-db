package com.select.redis.db.common.utils;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.select.redis.db.common.config.RedisConfig;
...
// ============================String=============================
    ...
    public double hashIncr(String key, String item, double by) {
        try {
            ...
            logger.error("将redis中key:{}的Hash类型的键key:{}的值新增{} 异常", key, item, by);
            e.printStackTrace();
    ...
    public double hashDecr(String key, String item, double by) {
        try {
            ...
            logger.error("将redis中key:{}的Hash类型的键key:{}的值减少{} 异常", key, item, by);
            e.printStackTrace();
...
// ===============================list=================================
    ...
    public boolean expire(String key, long time, int db) {
        try {
            ...
            logger.error("指定db:{}中key:{}缓存失效时间time:{} 异常", db, key, time);
            e.printStackTrace();
        }
        return false;
    }
...
// ============================String=============================
    ...
    public boolean set(String key, Object value, long time, int db) {
        try {
            ...
            logger.error("将key:{}的值存在db:{}设置过期时间time:{} 异常", key, db, time);
            e.printStackTrace();
        }
        return false;
    }
    ...
    public long incr(String key, long delta, int db) {
        try {
            ...
            logger.error("将db:{}中key:{}的值增加{} 异常", db, key, delta);
            e.printStackTrace();
            throw new RuntimeException("redis递增" + key + "的值异常");
        }
    }
    ...
    public long decr(String key, long delta, int db) {
        try {
            ...
            logger.error("将db:{}中key:{}的值减少{} 异常", db, key, delta);
            e.printStackTrace();
            throw new RuntimeException("redis减少" + key + "的值异常");
        }
    }
    ...
    public Object hashGet(String key, String item, int db) {
        try {
            ...
            logger.error("获取db:{}中key:{}的Hash类型的数据key:{}的值 异常", db, key, item);
            e.printStackTrace();
        }
        return null;
    }
    ...
    public boolean hashSet(String key, Map<String, Object> map, long time, int db) {
        try {
            ...
            logger.error("设置db:{}中key:{}的Hash类型值,过期时间time:{} 异常", db, key, time);
            e.printStackTrace();
        }
        return false;
    }
    ...
    public boolean hashSet(String key, String item, Object value, int db) {
        try {
            ...
            logger.error("设置db:{}中key:{}的Hash类型值键key:{}的值 异常", db, key, item);
            e.printStackTrace();
        }
        return false;
    }
    ...
    public boolean hashSet(String key, String item, Object value, long time, int db) {
        try {
            ...
            logger.error("设置db:{}中key:{}的Hash类型值键key:{}的值及过期时间 异常", db, key, item);
            e.printStackTrace();
        }
        return false;
    }
    ...
    public void hashDel(int db, String key, Object... item) {
        try {
            ...
            logger.error("删除db:{}中key:{}的Hash类型值键key:{}的值 异常", db, key, item);
            e.printStackTrace();
        }
    }
    ...
    public boolean isHashKeyExist(String key, String item, int db) {
        try {
            ...
            logger.error("判断db:{}中key:{}的Hash类型是否存在键key:{} 异常", db, key, item);
            e.printStackTrace();
        }
        return false;
    }
    ...
    public double hashIncr(String key, String item, double by, int db) {
        try {
            ...
            logger.error("将db:{}中key:{}的Hash类型的键key:{}的值新增{} 异常", db, key, item, by);
            e.printStackTrace();
            throw new RuntimeException("redis新增Hash中" + key + "的值异常");
        }
    }
    ...
    public double hashDecr(String key, String item, double by, int db) {
        try {
            ...
            logger.error("将db:{}中key:{}的Hash类型的键key:{}的值减少{} 异常", db, key, item, by);
            e.printStackTrace();
            throw new RuntimeException("redis减少Hash中" + key + "的值异常");
        }
    }
...
// ===============================list=================================
    ...
    public Object lGetIndex(String key, long index, int db) {
        try {
            ...
            logger.error("获取db:{}中key:{}的List类型索引index:{}的值 异常", db, key, index);
            e.printStackTrace();
        }
        return null;
    }
    ...
    public boolean lUpdateIndex(String key, long index, Object value, int db) {
        try {
            ...
            logger.error("修改db:{}键key:{}的List类型索引为index:{}的值 异常", db, key, index);
            e.printStackTrace();
        }
        return false;
    }
    ...
    public long lRemove(String key, long count, Object value, int db) {
        try {
            ...
            logger.error("移除db:{}键key:{}的List类型count:{}个值 异常", db, key, count);
            e.printStackTrace();
        }
        return 0;
    }
